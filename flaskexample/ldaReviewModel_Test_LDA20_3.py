...
def ldaReviewModel_Test(user_review_texts):
    ...
    selected_topic_title = {2:'Communication', 9:'Transportation',11:'Neighbourhood:Convenience',12:'Experience',14:'Arrival',15:'Neighbourhood:Fun',17:'Food',18:'Amenity'}
    min_prob = 0.00001
    ...
    custom_stop = ['stay','great','place','us','love','like','host','recommend','everything','san','francisco','perfect',
               'location','apartment', 'nice','good','definitely','really','room','house', 'didn','also','just','even',
               'well','make','will','much','airbnb']
